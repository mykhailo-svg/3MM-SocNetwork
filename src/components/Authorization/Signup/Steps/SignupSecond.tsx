...
const SignupSecond: React.FC<TypeFirstFormProps> = ({
  Day,
  Month,
  Year,
  Password,
        ...
        <div className="signup__gender">
          ...
          >
            <div className="signup__gender-radio">
              <Radio {...controlProps("female")} sx={radioStyles} />
              <svg
                width="24"
                height="24"
                fill="none"
              ...
              >
                <g clip-path="url(#a)">
                  <path
                    d="M19 9a7 7 0 1 0-8 7v2h-1a1 1 0 0 0 0 2h1v1a1 1 0 0 0 2 0v-1h1a1 1 0 1 0 0-2h-1v-2a7 7 0 0 0 6-7Zm-7 5a5 5 0 1 1 0-10 5 5 0 0 1 0 10Z"
                    fill="#FFB7D5"
                  />
                </g>
                <defs>
            ...
            <div className="signup__gender-radio">
              <Radio {...controlProps("male")} sx={radioStyles} />
              <svg
                width="24"
                height="24"
                fill="none"
              ...
              >
                <g clip-path="url(#a)">
                  <path
                    d="M20 3.6a1 1 0 0 0-1-.6h-4a1 1 0 1 0 0 2h1.6l-2.4 2.4a7 7 0 1 0 1.4 1.4L18 6.4V8a1 1 0 1 0 2 0V3.6Zm-6.5 12.9a5 5 0 1 1-7.1-7 5 5 0 0 1 7.1 7Z"
                    fill="#FFB7D5"
                    opacity=".6"
                  />
                </g>
