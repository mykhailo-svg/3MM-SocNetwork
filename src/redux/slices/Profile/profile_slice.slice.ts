...
const initialState = {
  Posts: [
    {
      id: 1,
      post_text: "I just finished knitting a cozy sweater!",
      likes: 10,
      comments: 3,
      time: "10:30",
    },
    {
      id: 2,
      post_text: "Spent the afternoon painting a beautiful landscape.",
      likes: 5,
      comments: 2,
      time: "15:45",
    },
    {
      id: 3,
      post_text: "I scored a goal in today's soccer match!",
      likes: 15,
      comments: 6,
      time: "18:15",
    },
    {
      id: 4,
      post_text: "Experimented with a new recipe and baked a delicious cake.",
      likes: 8,
      comments: 1,
      time: "12:00",
    },
    {
      id: 5,
      post_text: "Took my dog for a long walk in the park. Such a fun day!",
      likes: 20,
      comments: 4,
      time: "09:00",
    },
